import { IconButton, Tooltip, Badge, Button } from "@material-ui/core";
...
const isTourOpenAtom = atom(false);
export const isFeedbackFormOpenAtom = atom(false);
...
const GuidedTour = () => {
	...
	const [isTourOpen, setIsTourOpen] = useAtom(isTourOpenAtom);
	...
	return !started ? null : (
		<>
			...
			<ButtonStartTour {...{ isFirstVisit, isDarkMode }} />
			{/* <LinkToGithub /> */}
...
function ButtonStartTour({ isFirstVisit, ...props }) {
				...
				<div style={{ lineHeight: "1.6em", fontSize: "0.9em" }}>
					...
					<p>
						...
						<a
							...
							rel="noopener noreferrer"
						>
							DeepMind{"'"}s AlphaFold had essentially solved the protein
							folding problem
						</a>{" "}
